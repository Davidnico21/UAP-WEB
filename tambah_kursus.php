        ...
        <section class="content-section">
            <div class="container">
                <div class="form-container">
                    ...
                    <form action="tambah_kursus_exe.php" method="POST">
                    <div class="form-group">
                            <label for="id_kursus">id Kursus:</label>
                            <input type="text" id="id_kursus" name="id_kursus" required>
                        </div>
                        <div class="form-group">
                            <label for="bidang">Nama Kursus:</label>
                        ...
                        <div class="form-group">
                            <a href="kursus_online.php" class="btn">Batal</a>
