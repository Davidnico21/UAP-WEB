    ...
    <section class="content-section">
        <div class="container">
            ...
            <?php 
                ...
                $ambil_data = mysqli_query($mysqli, "SELECT * FROM siswa");
            ...
            <tr>
                ...
                <td>
                    <a href="edit_siswa.php?student_id=<?php echo $data['student_id']; ?>" class="btn">Edit</a>
                    <br>
                    <br>    
                    <br>
                    <a href="hapus_siswa.php?student_id=<?php echo $data['student_id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus pengajar ini?')" class="btn">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </table>
